            ...
            <nav>
                <div class="hd_nav_box">
                    <ul class="logo_box">
                        ...
                        <li class="rs_logo">
                            <a href="./main.jsp" aria-label="리디셀렉트 홈으로 이동">
                    ...
                    <form class="h_ip_box" action="./search.jsp" method="get">
